...
tf.flags.DEFINE_integer('train_steps', 5000, '训练次数')
...
summary = tf.summary.FileWriter("E://logs", graph=sess.graph)                #自己添加
...
saver.save(sess=sess, save_path="Model/model.ckpt")                    #自己添加的本地模型保存
summary.close()
